<h2> 848 22
1812. Determine Color of a Chessboard Square</h2><hr><div><p>You are given <code>coordinates</code>, a string that represents the coordinates of a square of the chessboard. Below is a chessboard for your reference.</p>
