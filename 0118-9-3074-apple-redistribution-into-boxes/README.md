<h2> 118 9
3074. Apple Redistribution into Boxes</h2><hr><div><p>You are given an array <code>apple</code> of size <code>n</code> and an array <code>capacity</code> of size <code>m</code>.</p>
...
<pre><strong>Input:</strong> apple = [1,3,2], capacity = [4,3,1,5,2]
...
<pre><strong>Input:</strong> apple = [5,5,5], capacity = [2,4,2,7]
