<h2> 15 2
3545. Minimum Deletions for At Most K Distinct Characters</h2><hr><div><p>You are given a string <code>s</code> consisting of lowercase English letters, and an integer <code>k</code>.</p>
