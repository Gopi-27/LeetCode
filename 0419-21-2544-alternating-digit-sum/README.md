<h2> 419 21
2544. Alternating Digit Sum</h2><hr><div><p>You are given a positive integer <code>n</code>. Each digit of <code>n</code> has a sign according to the following rules:</p>
