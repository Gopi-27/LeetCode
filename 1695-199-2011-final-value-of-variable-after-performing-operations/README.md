<h2> 1695 199
2011. Final Value of Variable After Performing Operations</h2><hr><div><p>There is a programming language with only <strong>four</strong> operations and <strong>one</strong> variable <code>X</code>:</p>
