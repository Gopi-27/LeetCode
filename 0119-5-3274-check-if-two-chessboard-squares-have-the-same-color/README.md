<h2> 119 5
3274. Check if Two Chessboard Squares Have the Same Color</h2><hr><div><p>You are given two strings, <code>coordinate1</code> and <code>coordinate2</code>, representing the coordinates of a square on an <code>8 x 8</code> chessboard.</p>
